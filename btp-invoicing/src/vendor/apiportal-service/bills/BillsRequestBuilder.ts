 ...
 */
export class BillsRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Bills<T>, T> {
  /**
  ...
  delete(entityIdOrEntity: any, entityType?: string, fromDate?: Moment, toDate?: Moment): DeleteRequestBuilder<Bills<T>, T> {
    return new DeleteRequestBuilder<Bills<T>, T>(this.entityApi, entityIdOrEntity instanceof Bills ? entityIdOrEntity : {
