...
import { batch, changeset } from './BatchRequest';
  ...
  export function apiportalService<BinaryT = string,
BooleanT = boolean,
ByteT = number,
DecimalT = BigNumber,
DoubleT = number,
...
TimeT>> = defaultDeSerializers as any
  ):ApiportalService<DeSerializers<BinaryT,
BooleanT,
ByteT,
DecimalT,
DoubleT,
...
class ApiportalService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
