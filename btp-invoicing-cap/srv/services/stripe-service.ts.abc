...
export default class StripeService {
     ...
     */
    public getOrCreateCustomer = async (bill: Bill) => {
        /*
     ...
     */
    public createAndSendInvoice = async (bill: Bill, customer: Stripe.Customer) => {
     ...
     */
    private invoiceExists = async (bill: Bill): Promise<boolean> => {
